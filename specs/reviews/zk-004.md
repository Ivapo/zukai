...
3. **Phase 3 deferred to OQ-2/OQ-3, which were still open**
   (`/Users/ivapo/.claude/skills/spec-driven-dev/spec-authoring.md` §4 forbids a phase
...
Open questions closed by reading the source (per `/Users/ivapo/.claude/skills/spec-driven-dev/spec-authoring.md` §4):
...
**Round cap reached and escalated.** `/Users/ivapo/.claude/skills/spec-driven-dev/spec-authoring.md` §7.6 caps the loop
