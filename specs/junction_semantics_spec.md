---
id: zk-008
title: junction-semantics
status: accepted
last_updated: 2026-07-31
note: >
  Make a junction *mean* something — control, right-of-way rule, and the
  turn movements through it. Phase 1 stands; the movements were shipped and
  then removed. Read §0 before anything below.

phases:
  - name: "Phase 1 — Control and rule: the glyph stops lying"
    reviewed: 2026-07-26
    shipped: 2026-07-26
    cut: null
    by: null
  - name: "Phase 2 — A movement exists: the whole pipeline, from the panel"
    reviewed: 2026-07-26
    shipped: 2026-07-26
    cut: 2026-07-28
    by: zk-011
  - name: "Phase 3 — Movements drawn through the junction"
    reviewed: 2026-07-26
    shipped: 2026-07-26
    cut: 2026-07-28
    by: zk-011
  - name: "Phase 4 — Derive: every legal turn at once"
    reviewed: 2026-07-26
    shipped: 2026-07-26
    cut: 2026-07-28
    by: zk-011
...
supersedes: null
superseded_by: null
related: [zk-011, zk-005, zk-006, zk-007]
