...
note: >
  Make the drawn road honour the road model — class, lane widths, lane
  kinds, and two-way carriageways that don't sit on top of each other.

phases:
  - name: "Phase 1 — Lane geometry from the model"
    reviewed: 2026-07-25
    shipped: 2026-07-25
    cut: null
    by: null
  ...
  - name: "Phase 3 — Two-way carriageways"
    ...
    cut: null
    by: null
  - name: "Phase 4 — Lane kinds and line semantics"
    reviewed: 2026-07-25
    shipped: 2026-07-25
    cut: null
    by: null
