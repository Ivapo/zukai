 ...
 *
 * **Which turns the junction permits is not a row here.** It is paint on the
 * approach — a `turn_arrow` marking per lane, edited in the marking panel — so
 * this one carries control and glyph only (lane arrows §2.1).
 */
